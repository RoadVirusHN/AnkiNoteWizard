...
export type FieldData = {
  ...
  content: string; // concat of field properties content, e.g. text content, image url, audio url, etc.
}
...
// TODO : change interface name to Field Part? Field Component? && translation
