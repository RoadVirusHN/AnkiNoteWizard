...
#### Preview 커스텀 CSS (예정)
- Anki에서 사용하고 있는 본인의 CSS 설정을 AnkiConnect로 가져와 프리뷰에 적용
- 설정에서 해당 Styling Css를 바꿀 수 있도록 하는 기능

### Version 2.0

#### AI based Template generation (예정)
- 텍스트 기반 노트 설명과 웹페이지 화면 HTML 코드로 템플릿 데이터 자동 생성
- 혹은 이를 위한 SKILL.MD 작성

#### 추가 언어 지원 (예정)
- 스페인어, 일본어, 아랍어, 러시아어, 프랑스어, 독일어 등...
